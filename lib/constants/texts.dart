...
const String EMPTY_ANIMATION_KEY_0 = "BOTH_VALUES_EMPTY";
...
const String SWTICHER_NEGATIVE_RADIUS = "Switcher radius cannot be negative";

const String DIMENSIONS_ERROR =
...
const String EMPTY_ICONS_KEY = "NULL-MDJD-KKNX";

const String ON_ICON_SWITCHER_KEY = "SNOE-NHUY-WWHD";
const String OFF_ICON_SWITCHER_KEY = "NMDO-NOWC-FUCK";
const String EMPTY_ICON_SWITCHER_KEY = "NULL-DXFS-AJNF";
